...
def migrate_difficulty_column(app):
    """
    Safe migration: adds difficulty_level column to the applications table
    if it does not already exist, and back-fills existing rows with 'Fundamental'.
    Works with SQLite (no ALTER TABLE ... DEFAULT support in all versions).
    """
    ...
    if 'difficulty_level' not in columns:
        print("Migrating: adding difficulty_level column to applications ...")
        cursor.execute(
            "ALTER TABLE applications ADD COLUMN difficulty_level VARCHAR(20) NOT NULL DEFAULT 'Fundamental'"
        )
        conn.commit()
        print("Migration complete - all existing rows set to 'Fundamental'.")
...
def seed_data(app):
    with app.app_context():
        ...
        # Domains
        domains_data = [
            ('Physics', 'A', 'Explore the fundamental laws governing matter, energy, space and time.'),
            ('Chemistry', 'B', 'Discover chemical reactions, molecular structures and material properties.'),
            ('Biology', 'C', 'Understand life, organisms, ecosystems and biological processes.'),
            ('Mathematics', 'D', 'The universal language of patterns, logic and quantitative reasoning.'),
            ('Computer Science', 'E', 'Algorithms, data structures, software engineering and computation.'),
            ('AI & Machine Learning', 'F', 'Intelligent systems, neural networks and data-driven learning.'),
            ('Mechanical Engineering', 'G', 'Design and analysis of mechanical systems and devices.'),
            ('Electrical Engineering', 'H', 'Circuits, electromagnetism, electronics and power systems.'),
            ('Medical & Healthcare', 'I', 'Medicine, physiology, diagnostics and therapeutic techniques.'),
            ('Economics & Finance', 'J', 'Markets, decision-making, resource allocation and financial systems.'),
            ('Psychology', 'K', 'Human behavior, cognition, emotion and mental processes.'),
            ('Environmental Science', 'L', 'Earth systems, ecology, climate and sustainability.'),
            ('Architecture & Design', 'M', 'Built environments, spatial design and aesthetic principles.'),
            ('Civil Engineering', 'N', 'Infrastructure, structures, transportation and urban systems.'),
            ('Business & Management', 'O', 'Strategy, operations, leadership and organizational behavior.'),
        ]
        ...
        # Applications for Bernoulli's Principle - varied difficulty levels
        apps_data = [
            {
                ...
                'description': 'Aircraft wings (airfoils) are shaped so air travels faster over the curved top surface than the flat bottom. '
                               'Per Bernoullis Principle, this faster airflow creates lower pressure above the wing than below, '
            ...
            },
            {
                ...
                'description': 'A carburetor uses Bernoullis Principle to mix air and fuel in the correct ratio for combustion. '
            ...
            },
            {
                ...
                'description': 'Bernoullis Principle governs blood flow in our circulatory system. When arteries narrow due to plaque buildup (stenosis), '
        ...
        rocket = Application(
            ...
            description="Rockets work entirely on Newton's Third Law: for every action there is an equal and opposite reaction. "
                        ...
                        'The rocket is pushed upward with equal force (reaction). In the vacuum of space where there is no air to push against, '
        ...
        db_index = Application(
            ...
            description='Modern databases use B-trees (a generalization of binary search) to index millions of records. '
                        ...
                        'using binary search, versus 500 million comparisons on average for a linear scan. '
